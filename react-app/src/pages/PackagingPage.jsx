  ...
  return (
    <>
      <style>{`
        ...
        .pp-page .sticky-cta { display: none; position: fixed; bottom: 0; left: 0; right: 0; z-index: 50; background: var(--ink); padding: 14px 18px; align-items: center; justify-content: space-between; gap: 14px; border-top: 1px solid #000; }
        .pp-page .sticky-cta .txt { color: #fff; font-size: 13px; }
        .pp-page .sticky-cta .txt b { display: block; font-size: 14.5px; }
        .pp-page .sticky-cta a { background: var(--paper); color: var(--ink); padding: 11px 18px; font-size: 13px; font-weight: 600; border-radius: var(--radius); white-space: nowrap; text-decoration: none; }
        .pp-page .sticky-cta a.wa-btn { background: #25D366 !important; color: #ffffff !important; padding: 0 !important; width: 38px !important; height: 38px !important; min-width: 38px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important; border-radius: 4px !important; }
